...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if(isset($_POST['ma_tgia'])) {
        ...
        echo "Không tồn tại 'ma_tgia' trong mảng POST.";
    }
}
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <div class="input-group mt-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="ma_tgia" value="<?php echo $ma_tgia; ?>"required readonly>
                     
                </div>
                <div class="input-group mt-3 mb-3">
                    <span class="input-group-text" id="lblCatName">Tên tác giả</span>
                    <input type="text" class="form-control" name="ten_tgia" value="<?php echo $ten_tgia; ?>" required>
                </div>

                <div class="input-group mt-3 mb-3">
                    <span class="input-group-text" id="lblCatName">Ảnh tác giả</span>
                    <input type="file" name="hinh_tgia" value="<?php echo $hinh_tgia; ?>" required>
                </div>
